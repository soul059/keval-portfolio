...
const createBanner = () : string[] => {
  ...
  banner.push("Try: <span class='cmd-chip' data-command='about'>about</span> <span class='cmd-chip' data-command='projects'>projects</span> <span class='cmd-chip' data-command='education'>education</span> <span class='cmd-chip' data-command='repo'>repo</span>");
