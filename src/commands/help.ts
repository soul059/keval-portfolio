const helpObj = {
  ...
  "terminalOs": [
    ...
    ["'blogs [search <query>|tag <tag>]'", "List or search published blogs. Examples: blogs, blogs search react, blogs tag javascript"],
    ["'blog view <slug>'", "Display full blog content in-terminal. Example: blog view my-first-post"],
